...
export const getFarms = (data) => {
  const farms: FarmConfig = data.map((farm) => {
    return {
      ...
      lpAddresses: {
        10000: farm.lp_mainnet_address,
        10001: '0xE66790075ad839978fEBa15D4d8bB2b415510000a1D',
      },
      tokenSymbol: farm?.token?.symbol,
      tokenAddresses: {
        10000: farm?.token?.mainnet_address,
        10001: '0xa35062141fa33bca92ce69fed37d0e8908868aae',
      },
