...
const fetchFarms = async () => {
  const data = await Promise.all(
    farmsConfig.map(async (farmConfig) => {
      ...
      const [info, totalAllocPoint, poolInfo, tropicalPerBlock] = await multicall(masterchefABI, [
        {
      ...
      return {
        ...
        tropicalPerBlock: new BigNumber(tropicalPerBlock).toNumber(),
