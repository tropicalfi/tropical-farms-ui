...
import { Button, Flex, Text, HelpIcon } from '@pancakeswap-libs/uikit'
...
const CardActions: React.FC<FarmCardActionsProps> = ({ lpPrice, farm, account, addLiquidityUrl }) => {
