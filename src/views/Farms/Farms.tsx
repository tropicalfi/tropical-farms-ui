  ...
  const farmsList = useCallback(
    (farmsToDisplay): FarmWithStakedValue[] => {
      ...
      let farmsToDisplayWithAPY: FarmWithStakedValue[] = farmsToDisplay.map((farm) => {
        ...
        //   return farm
        // }
        const cakeRewardPerBlock = new BigNumber(farm.tropicalPerBlock || 1)
    ...
    <Hero>
      <div>
        <Heading as="h1" size="xxl" mb="16px">
          {TranslateString(282, 'Tropical Islands')}
        </Heading>
        <ul>
      ...
      <img src="/images/farms.png" alt="SYRUP POOL icon" width={410} height={191} />
    </Hero>
      <ControlContainer>
        <ViewControls>
...
;
    ...
    <Hero>
      <div>
        <Heading as="h1" size="xxl" mb="16px">
          {TranslateString(282, 'Tropical Pools')}
        </Heading>
        <ul>
          <li>{TranslateString(580, 'Stake tokens to earn DAIQUIRI.')}</li>
          <li>{TranslateString(404, 'You can unstake at any time.')}</li>
