...
const CakeStats = () => {
  ...
  let tropicalPerBlock = 0
  if (farms && farms[0] && farms[0].tropicalPerBlock) {
    tropicalPerBlock = new BigNumber(farms[0].tropicalPerBlock).div(new BigNumber(10).pow(18)).toNumber()
  }
  ...
  return (
    <StyledCakeStats>
      <CardBody>
        ...
        <Row>
          <Text fontSize="14px">New Daiquiri/block</Text>
