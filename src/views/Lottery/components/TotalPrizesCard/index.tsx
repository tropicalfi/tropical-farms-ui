...
import { Heading, Card, CardBody, CardFooter, Text, LogoIcon, Flex, Skeleton } from '@pancakeswap-libs/uikit'
        ...
        <CardHeading>
          <Left>
            ...
            <PrizeCountWrapper>
              ...
              <Heading size="lg">{lotteryPrizeWithCommaSeparators} DAIQUIRI</Heading>
            </PrizeCountWrapper>
          </Left>
          <Right>
